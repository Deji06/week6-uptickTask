...
import backGroundImage from "../../../public/pexels-cottonbro-3944416.jpg";
...
const TaskDashboard = () => {
  ...
  return (
    <div className="pb-20 bg-cover min-h-screen relative ">
      ...
      <div className="relative z-10 py-14 md:py-10">
        <button
              ...
              <div className="flex flex-col">
                {displayEditForm && (
                  ...
                  >
                    ...
                    />
                    {updateTaskError && (
                      <p className="text-red-500">{updateTaskError}</p>
                    )}
